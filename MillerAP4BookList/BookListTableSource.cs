...
{
	public class BookListTableSource : UITableViewSource  { 	protected string[] tableItems; 	protected string cellIdentifier = "TableCell";  	public BookListTableSource (string[] items) 	{ 		tableItems = items; 	}
...
 	public override UITableViewCell GetCell (UITableView tableView, 
	...
	public override void RowSelected (UITableView tableView, NSIndexPath indexPath) 	{ 		new UIAlertView("Row Selected", tableItems[indexPath.Row], 
